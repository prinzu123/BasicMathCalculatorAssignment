...
public class subraction extends AppCompatActivity implements View.OnClickListener {
    ...
    public void ComputeResult(){
        ...
        resultMessage = (int) result + " " + "is the Difference of " + strnumber + " ➖ " +strnumber1 + " ➖ " +strnumber2;
