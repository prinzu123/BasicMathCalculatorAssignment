...
public class fahrenheit extends AppCompatActivity implements View.OnClickListener {
    EditText etnumber;
    String  strnumber, resultMessage;
    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ctoflayout);
    ...
    public void ComputeResult(){
        ...
        double result = rawNumber * 9/5 + 32;

        resultMessage = (int) result + " " + "is the fahrenheit of " + strnumber +" Celsius";
